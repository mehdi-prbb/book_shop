# Generated by Django 4.1 on 2022-12-06 17:25
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('choices', models.ManyToManyField(related_name='mobile_choices', to='products.choices')),
                ('product', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='mobiles', to='products.product')),
            ],
        ),
        migrations.CreateModel(
            name='Laptop',
            fields=[
                ...
                ('choices', models.ManyToManyField(related_name='laptop_choices', to='products.choices')),
                ('product', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='laptops', to='products.product')),
            ],
        ),
    ]
